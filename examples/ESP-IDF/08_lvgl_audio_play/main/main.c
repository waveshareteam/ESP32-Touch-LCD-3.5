...
static esp_err_t app_lcd_init(void)
{
    ...
    ESP_RETURN_ON_ERROR(spi_bus_initialize(SDSPI_HOST, &buscfg, SPI_DMA_CH_AUTO), TAG, "SPI init failed");
    ...
    ESP_GOTO_ON_ERROR(esp_lcd_new_panel_io_spi((esp_lcd_spi_bus_handle_t)SDSPI_HOST, &io_config, &lcd_io), err, TAG, "New panel IO failed");
...
void app_i2c_init(void)
{
    ...
    i2c_mst_config.i2c_port = (i2c_port_num_t)I2C_NUM;
